...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{mess: '', status: author$project$Main$Init, url: ''},
		...
		switch (msg.$) {
			...
			case 'URL':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{status: author$project$Main$Init, url: url}),
					elm$core$Platform$Cmd$none);
			default:
				var result = msg.a;
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{mess: fullText, status: author$project$Main$Success}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{mess: '', status: author$project$Main$Failed}),
						elm$core$Platform$Cmd$none);
				}
		}
	});
var author$project$Main$GET = {$: 'GET'};
var author$project$Main$URL = function (a) {
	return {$: 'URL', a: a};
};
...
var author$project$Main$viewMain = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A4(author$project$Main$viewInput, 'text', 'Input your url', model.url, author$project$Main$URL),
				A2(
