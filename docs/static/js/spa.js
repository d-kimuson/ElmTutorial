			...
			case 'UrlChanged':
				...
				if (_n2.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{route: author$project$Main$NotFound, url: url}),
						elm$core$Platform$Cmd$none);
				}
			default:
				var route = msg.a;
		...
		case 'Home':
			return A3(
				...
				A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text('This is Home page!')
						])));
		case 'Profile':
			return A3(
				author$project$Main$viewPage,
				...
				A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text('This is Profile page!')
						])));
		case 'Reviews':
			var info = _n0.a;
			return A3(
				...
				A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text('This is Reviews page!')
						])));
		default:
			return {
				body: _List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								author$project$Main$route2string(model.route))
							]))
					]),
				title: 'NotFound'
			};
